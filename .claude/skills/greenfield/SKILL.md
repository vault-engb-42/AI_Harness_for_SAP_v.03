...
- **The pipeline never releases (P5).** `/greenfield` stops at a release-ready (or binding-unverified) transport with proof. Release DEV→QA→PRD is the human's action.
