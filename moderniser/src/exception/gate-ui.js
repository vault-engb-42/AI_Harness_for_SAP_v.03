 ...
 */
export function recordDecision(register, id, decision, { decided_by, ts, run_id, decided_cycles }) {
  ...
  return resolveEscalation(register, id, { resolved_by: decided_by, ts, decision, run_id, decided_cycles });
}
