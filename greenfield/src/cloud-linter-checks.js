...
export const AUTHCHECK_SPEC = { rule_id: "gf-inv-authcheck-no-subrc", severity: "error", family: "invariant", message: "AUTHORITY-CHECK is not followed by an SY-SUBRC test — the authorization result is ignored; P4(c) requires SY-SUBRC checked after every AUTHORITY-CHECK (hard invariant)" };
