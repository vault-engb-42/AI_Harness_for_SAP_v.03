...
import { cdsNamingFindings, bdefImplClassNamingFindings } from "./naming-checks.js";
...
export function lintAbapCloud(files) {
  ...
  findings.push(...cdsNamingFindings(list));
  findings.push(...bdefImplClassNamingFindings(list));
