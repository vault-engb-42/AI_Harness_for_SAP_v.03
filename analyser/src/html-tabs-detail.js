...
import { esc, num, round, bar, jsonIsland } from "./html-util.js";

/**
 * §3.E HTML report — the detail / data-heavy tab renderers (boundaries, layers,
 * tech-debt, findings, cloud readiness, SARIF), split from html-tabs.js to keep
 * every module under the 300-line limit. The dependency-graph tab lives in
 * html-graph.js. Deterministic, pure, P8-escaped.
 */
