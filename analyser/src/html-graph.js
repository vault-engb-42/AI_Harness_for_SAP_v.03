...
<div class="gbar"><b>View</b> <button type="button" onclick="gLayout('layered')">Hierarchy</button> <button type="button" onclick="gLayout('force')">Force</button> <button type="button" onclick="gLayout('matrix')">Matrix</button> <span class="sep">·</span> <span class="gzoom"><b>Zoom</b> <button type="button" onclick="gZoom(1.25)">+</button> <button type="button" onclick="gZoom(0.8)">−</button> <button type="button" onclick="gFit()">Fit</button> <button type="button" onclick="gReset()">Reset</button></span></div>
